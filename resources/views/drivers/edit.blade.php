        ...
        <div class="flex flex-col justify-center w-1/2 bg-white rounded-lg shadow-xl p-4">
            <form action="{{ route('drivers.update', ['driver' => $driver]) }}" method="POST">
                ...
                <div class="flex justify-end ">
                    <button>
                        <div type="submit"
                            class="block text-white mt-6 mb-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Confirm
                        </div>
                    </button>
                </div>

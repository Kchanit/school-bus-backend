                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <h3 class="text-lg font-normal text-gray-500">Are
                                                        you sure you want to delete {{ $student->getFullName() }}?</h3>
                                                    <div class="flex justify-center mt-8">
                                                        <form
                                                            action="{{ route('student.remove', ['student' => $student]) }}"
                                                            method="POST">
                                                            @csrf
                                                        ...
                                                        <button data-modal-hide="popup-modal-{{ $student->id }}"
                                                            type="button"
